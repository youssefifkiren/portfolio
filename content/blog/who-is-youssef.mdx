...
<MdImg
  ...
  width={400}
  height={600}
  className="rounded-full shadow-lg ml-auto my-6 max-w-[200px] md:max-w-[300px] aspect-square object-cover float-right"
/>
## Who I Am

My name is **Youssef Ifkiren**, and I'm a passionate Software engineer. Currently studying Master's degree diving into the world of **Artificial Intelligence**, 
...
My main goal with this blog is to share my story and the lessons I learn along the way. I'll be documenting my projects, exploring new technologies, and sharing insights from my AI studies.
...
You can expect to find posts on a variety of topics, including:

* **Web Development:** Deep dives into tricks on frameworks like React, Next.js, and Svelte.
...
* **Personal Projects:** Showcasing the fun and challenging projects I build in my free time.

Thank you for being here at the start of this new chapter. I'm excited to share this journey with you.
